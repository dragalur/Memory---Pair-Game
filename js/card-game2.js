...
function Card(elem) {
   this.arrayImage = ['1.jpg', '2.jpg', '3.jpg', '4.jpg', '5.jpg', '6.jpg', '7.jpg', '8.jpg'];
   this.arrayImage = this.arrayImage.concat(this.arrayImage); //array + array
   //function of refrest item in array
   this.arrayImage.sort(function () {
      return 0.5 - Math.random();
   });
   this.blocksImage = document.getElementsByClassName(elem);
   for (let i = 0; i < this.arrayImage.length; i++) {
      this.blocksImage[i].style.backgroundImage = 'url(/image/' + this.arrayImage[i] + ')';
   }
}
